...
"""Genera las capturas del README a partir de la aplicación de verdad.
    ...
    python -m uvicorn backend.main:app --port 8030     # en otra consola
...
ESCENAS = [
    ("01-garaje", "tablero", "auto_estaciona", "garaje", 18, 1500, 1000),
    ("02-vigilancia", "tablero", "entradas", "vigilancia", 16, 1500, 1000),
    ("03-editor-de-zonas", "editor", "auto_estaciona", "garaje", 0, 1500, 1000),
]
