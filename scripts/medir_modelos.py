...
MODELOS = [
    ("weights/yolo11n.pt", "Personas y vehículos",
     "videos/auto_estaciona.mp4", 0.30),
    ("weights/face_yolov8s.pt", "Rostros, para el recorte de la entrada",
     "videos/peatones_arcos.mp4", 0.30),
]
...
FUENTES = {
    ...
    "face_yolov8s.pt": ("Detector de rostro de adetailer",
     None),
}
...
UMBRALES = [
    ("Confianza · personas y vehículos", "0.30",
     "Más bajo que en retail: la cámara está más lejos y una persona en el fondo del garaje sale pequeña. Un falso positivo aquí cuesta poco; no detectar a alguien que entra, mucho."),
    ("IoU de NMS", "0.60",
     "Funde las cajas dobles sobre el mismo coche o la misma persona."),
    ("Activación de ByteTrack", "0.25",
     "Por debajo de la confianza de detección, para no perder el ID de alguien que se tapa un momento tras una columna."),
    ("Confianza · rostro", "0.30",
     "Con cara mínima de ~28 px. Por debajo salen recortes que no son una cara, y eso es peor que no recortar nada."),
    ("Fotogramas para confirmar un rostro", "3",
     "Un solo fotograma bueno puede ser un reflejo. Tres seguidos, no."),
]
